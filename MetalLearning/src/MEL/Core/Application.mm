...
namespace MEL{
	...
	void Application::Run() {
		...
		m_Window->Show();
		//too funny i have to record it.i accidentally put show() in while loop,then i try to miniaturize my window,and that is ,the window keep showing and the log dont output anything.i stuck for almost 3 hours!how silly was i
		while (m_Running){
			@autoreleasepool {
				NSEvent* event;
